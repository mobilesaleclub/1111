...
$shortcode_css = SIMPLE_BASE_URL.'css/bootstrap.css';
...
<script type="text/javascript" src="<?php echo SIMPLE_BASE_URL.'js/bootstrap.js'; ?>"></script>

<link rel="stylesheet" href="<?php echo esc_url($shortcode_css); ?>">
<link rel="stylesheet" href="<?php echo SIMPLE_BASE_URL.'style.css' ?>">
</head>
