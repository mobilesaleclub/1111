    ...
    tinymce.create("tinymce.plugins.ShortcodeNinjaPlugin", {
        ...
        init: function (d, e) {
            ...
            d.addButton( 'scn_button', {
                ...
                image : simple_global.frameworkUrl + "includes/core/shortcodes/mce/img/icon.png",
                icons : false,
...

        {
        	...
        	if(simple_global && simple_global.shortcodes) shortcodes = simple_global.shortcodes;
        ...
        createControl: function (d, b) {
                ...
                if(simple_global && simple_global.shortcodes) 

                {

                	shortcodes = simple_global.shortcodes;

                	

                	if(typeof simple_global.shortcodes.remove != 'undefined')

                	{

	                	remove = simple_global.shortcodes.remove;
