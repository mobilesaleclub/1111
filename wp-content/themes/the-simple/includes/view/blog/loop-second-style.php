...
if (have_posts()) :
    ...
    while (have_posts()) : the_post();
        ...
        $attach_size = 'simple_alternate_blog';
        if($simple_redata['bloglayout'] != 'fullwidth')
            $attach_size = 'simple_alternate_blog_side';
         ...
         ?>
                ...
                <div class="media">
                    ...
                    <?php if($post_format == 'audio'){
                        ...
                        <img src="<?php echo esc_url(simple_image_by_id(get_post_thumbnail_id(), $attach_size, 'url')) ?>" alt="">
                ...
                <div class="content">
                    ...
                    <div class="text">
                        <?php   if($post_format == 'video' || $post_format == 'audio')
                                    echo simple_text_limit(get_the_content(), 70);
                                else
                                    echo simple_text_limit(get_the_excerpt(), 70);
                        ?>
                    </div>
