         ...
         ?>
                ...
                <div class="media">
                    ...
                    <?php if($post_format == 'audio'){
                        ...
                        <?php if(!is_single() || (is_single() && $simple_redata['use_featured_image_as_photo']) ): ?>
                         ...
                         <div class="post_navigation">
                                    ...
                                    <a class="prev" href="<?php echo esc_url(get_permalink(get_previous_post()->ID)); ?>">
                                        <span class="icon-wrap"><i class="lnr lnr-arrow-left"></i></span>
                                            ...
                                            <h3><?php _e('Previous Post', 'the-simple') ?></h3>
                                            <h6><?php echo esc_html(get_previous_post()->post_title); ?></h6>
                                    ...
                                    <a class="next" href="<?php echo get_permalink(get_next_post()->ID); ?>">
                                        <span class="icon-wrap"><i class="lnr lnr-arrow-right"></i></span>
                                            ...
                                            <h3><?php _e('Next Post', 'the-simple') ?></h3>
                                            <h6><?php echo esc_html(get_next_post()->post_title); ?></h6>
