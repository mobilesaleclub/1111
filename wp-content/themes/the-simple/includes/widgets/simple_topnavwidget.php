...
class SimpleTopNavWidget extends WP_Widget{
    ...
    function widget($atts, $instance){
        ...
        if(in_array("mail", $selected)){
	        ...
	        echo '<div class="mail small_widget">';
	        	echo '<a href="#" data-box="mail"><i class="moon-envelope-alt"></i>'.__('Mailing List', 'the-simple').'</a>';
	    ...
	    if(in_array("search", $selected)){
	        ...
	        echo '<div class="search small_widget">';
	        	echo '<a href="#" class="getdata" data-box="search"><i class="moon-search-3"></i>'.__('Search', 'the-simple').'</a>';
	    ...
	    if(in_array("login", $selected)){
	        ...
	        echo '<div class="login small_widget">';
	        	echo '<a href="#" data-box="login"><i class="moon-user"></i>'.__('Login', 'the-simple').'</a>';
		...
		?>
		  	...
		  	<input type="text" name="log" id="log" value="<?php echo esc_html(stripslashes($user_login)) ?>" size="20" placeholder="<?php _e('Username', 'the-simple') ?>" />
			<input type="password" name="pwd" id="pwd" size="20" placeholder="<?php _e('Password', 'the-simple') ?>"/>
		...
		if(in_array("multilanguage", $selected)){
	        ...
	        echo '<div class="multilanguage small_widget">';
	        	echo '<a href="#" data-box="multilanguage"><i class="moon-flag"></i>'.__('Select Language', 'the-simple').'</a>';
