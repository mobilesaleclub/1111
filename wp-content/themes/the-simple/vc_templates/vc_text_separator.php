...
<div class="<?php echo esc_attr( trim( $css_class ) ); ?>"><span
		class="vc_sep_holder vc_sep_holder_l"><span<?php echo wp_kses($inline_css, '', ''); ?>
			class="vc_sep_line"></span></span><?php if ( '' !== $title && 'separator_no_text' !== $layout ): ?>
		<h4><?php echo esc_html($title); ?></h4><?php endif; ?><span
		class="vc_sep_holder vc_sep_holder_r"><span<?php echo wp_kses($inline_css, '', ''); ?> class="vc_sep_line"></span></span>
